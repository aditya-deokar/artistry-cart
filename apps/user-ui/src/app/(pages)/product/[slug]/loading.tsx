...
export default function Loading() {
  return (
    <Bounded className="py-12 md:py-20 mt-4 animate-pulse">
      ...
      <div className="h-28 w-full rounded-lg bg-gray-200/95 dark:bg-gray-700/95 mb-8"></div>
      ...
      <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[80px_1fr] gap-4 items-start">
            <div className="flex md:flex-col gap-3 order-2 md:order-1">
                <div className="aspect-square w-full rounded-md bg-gray-200 dark:bg-gray-700"></div>
                <div className="aspect-square w-full rounded-md bg-gray-200 dark:bg-gray-700"></div>
                <div className="aspect-square w-full rounded-md bg-gray-200 dark:bg-gray-700"></div>
            </div>
            <div className="relative aspect-square w-full rounded-lg bg-gray-200 dark:bg-gray-700 order-1 md:order-2"></div>
        </div>
        ...
        <div className="flex flex-col gap-7">
            ...
            {/* Price */}
            <div className="h-10 w-1/2 rounded bg-gray-200 dark:bg-gray-700"></div>
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                <div className="h-10 w-16 rounded-full bg-gray-200 dark:bg-gray-700"></div>
                <div className="h-10 w-16 rounded-full bg-gray-200 dark:bg-gray-700"></div>
              </div>
              <div className="flex gap-3">
            ...
            {/* Add to Cart Form */}
            <div className="h-14 w-full rounded-full bg-gray-200 dark:bg-gray-700"></div>
