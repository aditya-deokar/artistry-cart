...
// Corrected type import path and added ShopInfo


// A component to display key specifications cleanly
// Updated the type to use the imported CustomSpecification
