...
> Canonical status: this file is an earlier architecture reference. For the current code-grounded system description, use [System Overview](</C:/Users/adity/Desktop/Artistry Cart/artistry-cart/docs/02-architecture/system-overview.md>), [Service Topology](</C:/Users/adity/Desktop/Artistry Cart/artistry-cart/docs/02-architecture/service-topology.md>), and the service docs under [03-applications](</C:/Users/adity/Desktop/Artistry Cart/artistry-cart/docs/03-applications>).
